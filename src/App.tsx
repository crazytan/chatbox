...
import { type Session, createSession, type Message, createMessage } from "./types";
          ...
          >
            <Toolbar style={{ padding: "0 10px" }}>
              ...
              <IconButton
                ...
                aria-label="menu"
                sx={{}}
                onClick={async () => { await saveSession(store.currentSession); }}
              >
                <Save />
              </IconButton>
            </Toolbar>
...
function sortSessions(sessions: Session[]): Session[] {
  ...
  for (const sess of sessions) {
    if (sess.starred !== undefined && sess.starred) {
      pinned.push(sess);
      continue;
    }
